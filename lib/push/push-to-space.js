                     ...
                     sequence = sequence
                       .then((allAssets = []) =>
                         assets
                           ...
                           .then((processedAssets) => allAssets.concat(processedAssets[0]))
                       )
                   });

                   return sequence.then((allFinished) => { console.log('all finished', allFinished); return allFinished;});
                 } else {
